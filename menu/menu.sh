...
curl -sS https://raw.githubusercontent.com/KhaiVpn767/MultiportV3/main/permission/ipmini > /root/tmp
...
MYIP=$(curl -sS ipv4.icanhazip.com)
Name=$(curl -sS https://raw.githubusercontent.com/KhaiVpn767/MultiportV3/main/permission/ipmini | grep $MYIP | awk '{print $2}')
...
PERMISSION () {
    MYIP=$(curl -sS ipv4.icanhazip.com)
    IZIN=$(curl -sS https://raw.githubusercontent.com/KhaiVpn767/MultiportV3/main/permission/ipmini | awk '{print $4}' | grep $MYIP)
    if [ "$MYIP" = "$IZIN" ]; then
    Bloman
    else
...
Exp=$(curl -sS https://raw.githubusercontent.com/KhaiVpn767/MultiportV3/main/permission/ipmini | grep $MYIP | awk '{print $3}')
fi
#Domain & IPVPS
...
echo ""
echo -e "${BB}————————————————————————————————————————————————————————${NC}"
echo -e "     ${WB}SSH XRAYS Websocket Autoscript By KhaiVpn767${NC}"
echo -e "${BB}————————————————————————————————————————————————————————${NC}"
...
55) clear ; bbr3 ;;
66) clear ; bbr4 ;;
77) clear ; wget -q -O /usr/bin/swapram "https://raw.githubusercontent.com/KhaiVpn767/swapram/main/swapram.sh" && chmod +x /usr/bin/swapram && swapram ;;
88) clear ; wget -q -O /usr/bin/xraychanger "https://raw.githubusercontent.com/KhaiVpn767/Xcore-custompath/main/xraychanger.sh" && chmod +x /usr/bin/xraychanger && xraychanger
99) clear ; up ;;
0) clear ; menu ;;
x) exit ;;
