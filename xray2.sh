...
#wget -O /usr/local/bin/xray "https://raw.githubusercontent.com/KhaiVpn767/MultiportV3/main/xray.linux.64bit"
#chmod +x /usr/local/bin/xray

# generate certificates
mkdir /root/.acme.sh
curl https://raw.githubusercontent.com/KhaiVpn767/MultiportV3/main/acme.sh -o /root/.acme.sh/acme.sh
